...
python "$WERCKER_STEP_ROOT/main.py" "$WERCKER_HIPCHAT_NOTIFY_TOKEN" "$WERCKER_HIPCHAT_NOTIFY_ROOM_ID" "$WERCKER_HIPCHAT_NOTIFY_FROM_NAME" "$WERCKER_HIPCHAT_NOTIFY_MESSAGE" "$WERCKER_HIPCHAT_NOTIFY_COLOR" "$WERCKER_HIPCHAT_NOTIFY_NOTIFY" "$WERCKER_HIPCHAT_NOTIFY_MESSAGE_FORMAT"
