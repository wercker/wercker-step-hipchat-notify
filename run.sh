...
echo "run python"
echo "WERCKER_HIPCHAT_NOTIFY_TOKEN $WERCKER_HIPCHAT_NOTIFY_TOKEN"
echo "WERCKER_HIPCHAT_NOTIFY_ROOM_ID $WERCKER_HIPCHAT_NOTIFY_ROOM_ID"
echo "WERCKER_HIPCHAT_NOTIFY_FROM_NAME $WERCKER_HIPCHAT_NOTIFY_FROM_NAME"
echo "WERCKER_HIPCHAT_NOTIFY_MESSAGE $WERCKER_HIPCHAT_NOTIFY_MESSAGE"
